...
use augur_plugin_api::{LocalizationTable, PluginInput};
...
use crate::{
    ...
    reconstruction::{
        export_csv_to_path, export_image_to_path, render_reconstruction_viewport,
        ReconstructionImageFormat, ReconstructionRenderSettings, ReconstructionSharedData,
        ReconstructionState,
    },
...
impl CameraApp {
    ...
    fn export_reconstruction_csv(&mut self) {
        ...
        match export_csv_to_path(&path, table) {
